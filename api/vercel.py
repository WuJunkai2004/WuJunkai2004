...
class API(server.SimpleHTTPRequestHandler):
...
#============ response ============#
    ...
    def do_POST(self):
        self.vercel(self.path, self.translate_post(), self.headers)
...
def Start(handler = API,port=8000):
    server.test(
